        ...
        <div className="row">
          <div className="col-md-6">
            <div className="info">
              <h3>About us</h3>
              <p>
                The short-term vacation rental business is not as easy as it
                seems. My name is Peter Fischer, when I stepped into the STR
                industry, I struggled so hard to find out the tools and services
                required in it.
              </p>
              <div className="detail mt-4">
                <p>
                  Listing my properties on different listing sites, maintenance
              ...
              <div className="faqs mt-4">
                ...
                <Accordion>
                  <Accordion.Item eventKey="0">
                    <Accordion.Header>
                      What is VacationRentals.tools?
                    </Accordion.Header>
                    <Accordion.Body>
                      VacationRentals.toos is a directory of tools & resources
                      for the vacation rental industry
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="1">
                    <Accordion.Header>
                      How do I submit my website or business to the directory?{" "}
                    </Accordion.Header>
                    <Accordion.Body>
                      To submit your business to the directory, you will need to
                      click on the submit link on the menu. You will need to
                      create an account first.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="2">
                    <Accordion.Header>
                      How do I search for a specific website or business in the
                      directory?{" "}
                    </Accordion.Header>
                    <Accordion.Body>
                      You can search for a specific website or business in the
                      directory by using the search bar or categories menu
                      provided on the site.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="3">
                    <Accordion.Header>
                      How do I update my listing in the directory?{" "}
                    </Accordion.Header>
                    <Accordion.Body>
                      You will need to login into your account to edit your
                      listing.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="4">
                    <Accordion.Header>
                      How do I report a problem with a listing in the directory?{" "}
                    </Accordion.Header>
                    <Accordion.Body>
                      To report a problem with a listing in the directory, you
                      will need to follow the instructions provided by the
                      directory site. This may involve{" "}
                      <a href="/contact">contacting us</a> directly to report
                      the issue.
                    </Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey="5">
                    ...
                    <Accordion.Body>
                      Deals are special discounts that providers may have. We
                      have a special search function that allows you to filter
                      providers offering deals.
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
              </div>

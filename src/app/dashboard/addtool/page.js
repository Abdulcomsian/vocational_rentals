...
function Addtool() {
  ...
  const [cards, setCards] = useState([<div className="deal-body">
  <div className="deal-added">
    <div className="left">
      <h3>30% off Tella</h3>
      <div className="price">$11 <span className="line-through">$15</span> <span>/ Monthly</span> </div>
    ...
    <div className="right">
      ...
      <a href="#" className="buy-button">Visit Link</a>
    </div>
  </div>
</div>]);
  ...
  const handleDuplicate = () => {
    ...
    setCards(prevCards => [...prevCards, <div className="deal-body">
    <div className="deal-added">
      <div className="left">
        <h3>30% off Tella</h3>
        <div className="price">$11 <span className="line-through">$15</span> <span>/ Monthly</span> </div>
            ...
            <form>
              ...
              <div className="deals-sec">
                <div className="deal-head">
                  <h3>Add Deals</h3>
                  <a href="#"  data-bs-toggle="modal" data-bs-target="#editlistModal"><i className="las la-plus"></i>Add New Deal</a>
                </div>
                {cards.map(card => card)}
                                ...
                                <form>
                                    ...
                                    <div className="row mb-3">
                                      ...
                                      <div className="col-md-4">
                                          ...
                                          <input type="text" className="form-control" placeholder='Actual Price' />
                                      </div>
                                      <div className="col-md-4">
                                    ...
                                    <div className="d-flex gap-2 justify-content-center mt-4 mb-2">
                                        <button type="button" className="btn w-sm btn-light" data-bs-dismiss="modal">Cancel</button>
                                        <button type="button" className="btn w-sm btn-danger" onClick={handleDuplicate}  data-bs-dismiss="modal">Add Deal</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
                <div className="modal-body">
                    ...
                    <p className="text-muted mx-4 mb-0 text-center mt-1">Are you sure you want to Delete this Deal?</p>
                    <div className="d-flex gap-2 justify-content-center mt-4 mb-2">
                        <button type="button" className="btn w-sm btn-light" data-bs-dismiss="modal">Close</button>
                        <button type="button" className="btn w-sm btn-danger" id="delete_company">Yes, Delete It!</button>
                    </div>
                </div>
            </div>
        </div>
